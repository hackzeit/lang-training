...
func Static(N uint32) func(n uint32) uint32 {
  F := make([]uint32, N) // Array de N+1 elementos que contienen los factoriales
  F[0], F[1] = 1, 1    // Inicializando L[0] = L[1] = 1
  k := uint32(2) //numero de elementos llenos en L
